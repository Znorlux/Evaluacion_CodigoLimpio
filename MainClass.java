...
public class MainClass {
    ...
    Programa Gestor_programa = new Programa();//Objeto de tipo programa para poder llamar a sus metodos
    ...
    Gestor_programa.verificar_invitado(id);//Ahora con ese ID, procedemos a hacer las verificaciones
    }
    else{
  ...
  public static int solicitar_id(){
    ...
    System.out.println("A continuación, ingrese el ID del invitado que desea verificar");
