...
abstract class Gestor_archivos {
    ...
    public abstract void leer_informacion(String ruta, String separador ) throws IOException;//es recomendable que Todo metodo que realicé un procedimiento de lectura de archivos, defina IOException
